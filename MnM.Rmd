...
Here, find attached the code utilized for carrying out the analysis of [Genetic Map](https://github.com/giovannigalli/mimulus/blob/gh-pages/ScriptMap.R) and [QTL Mapping](https://github.com/giovannigalli/mimulus/blob/gh-pages/QTLMapping.R).
