...
The aforementioned map was utilized for QTL mapping using R package R/qtl (Broman et al., 2003). To this end, three methods of QTL mapping were used, namely, Interval Mapping (IM), Composed Interval Mapping (CIM) and Multiple Interval Mapping (MIM).
